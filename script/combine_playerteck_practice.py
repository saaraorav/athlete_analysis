...
def main() -> None:
    ...
    #     print(
    #         f"PlayerTek filter: retained {combined_df.shape[0]} of {before_rows} rows with {filter_column} == 'game'."
    #     )
    # else:
...
def align_playertek_catapult_outputs(project_root: Path) -> None:
    ...
    output_path = project_root / "script" / "outputs" / "wsoc_playertek_combined_aligned_practice.csv"
