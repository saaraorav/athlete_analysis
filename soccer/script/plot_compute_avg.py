...
result = (
    event_avgs
      ...
      [['date', 'activity', 'avg_meterage', 'active_player',
...
for ax, year in zip(axes, years):
    ...
    for window in RECESS_WINDOWS:
        if window['year'] == year:
            ...
            ax.text(mid, 110, 'Recess', color='green', ha='center', va='bottom', fontsize=10)
...
# --- Export ---
output_path = "avg_player_meterage_by_year_connected.png"
